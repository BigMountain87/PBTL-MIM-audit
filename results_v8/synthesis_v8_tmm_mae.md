# v8 cross-structure synthesis — convention `tmm_mae` (negative Paper 1 operating-band TMM MAE (%))
...
- pooled_order: structures ranked by negative Paper 1 operating-band TMM MAE (%): A (-7.90) > B (-8.90) > C (-16.90)